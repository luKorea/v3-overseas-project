...
export default {
  ...
  message: {
    ...
    pageTwo_three: IMG_URL_ZH_TW + "/two-three.png",
    pageThree_one: IMG_URL_ZH_TW + "/three-one.png",
    pageThree_two: IMG_URL_ZH_TW + "/three-two.png",
    pageThree_three: IMG_URL_ZH_TW + "/three-three.png",
    pageThree_four: IMG_URL_ZH_TW + "/three-four.png",
    pageFour_one: IMG_URL_ZH_TW + "/four-one.png",
    pageFour_two: IMG_URL_ZH_TW + "/four-two.png",
    pageFour_three: IMG_URL_ZH_TW + "/four-three.png",
